...
async function generateContent(userPromptPart) {
  try {
    ...
    const image = {
    inlineData:{
        data:Buffer.from(fs.readFileSync("backend/main/enclosure/back.png")).toString("base64"),
        mimeType:"image/png",
    },
    };
    ...
    const imagef = {
    inlineData:{
        data:Buffer.from(fs.readFileSync("backend/main/enclosure/front.png")).toString("base64"),
        mimeType:"image/png",
    },
    };
    ...
    const imagel = {
    inlineData:{
        data:Buffer.from(fs.readFileSync("backend/main/enclosure/left.png")).toString("base64"),
        mimeType:"image/png",
    },
    };
    ...
    const imager = {
    inlineData:{
        data:Buffer.from(fs.readFileSync("backend/main/enclosure/right.png")).toString("base64"),
        mimeType:"image/png",
    },
    };
    ...
    const imageu = {
    inlineData:{
        data:Buffer.from(fs.readFileSync("backend/main/enclosure/top.png")).toString("base64"),
        mimeType:"image/png",
    },
    };
    ...
    const imaged = {
    inlineData:{
        data:Buffer.from(fs.readFileSync("backend/main/enclosure/bottom.png")).toString("base64"),
        mimeType:"image/png",
    },
    }; 

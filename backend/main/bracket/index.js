...
async function  generate_u_bracket(usable_bracket,context){
    const bracketConfig = `{
        "show2d": true,
        "show3d": true,
      ...
      const image = {
      inlineData:{
          data:Buffer.from(fs.readFileSync("backend/main/bracket/U.png")).toString("base64"),
          mimeType:"image/png",
      },
      };
      ...
      //just randomly fill the unused values of length
        ...
        const imagef = {
        inlineData:{
            data:Buffer.from(fs.readFileSync("backend/main/bracket/UF.png")).toString("base64"),
            mimeType:"image/png",
        },
        };
      ...
      9)Put only values in the json and no intermediate calculations or explanations`;
        const imageL1 = {
        inlineData:{
            data:Buffer.from(fs.readFileSync("backend/main/bracket/UL1.png")).toString("base64"),
            mimeType:"image/png",
        },
        };
     ...
     9)Put only values in the json and no intermediate calculations or explanations`;
        const imageL2 = {
         inlineData:{
             data:Buffer.from(fs.readFileSync("backend/main/bracket/UL2.png")).toString("base64"),
             mimeType:"image/png",
         },
         };
      ...
      9)Put only values in the json and no intermediate calculations or explanations`;
         const imageL3 = {
         inlineData:{
             data:Buffer.from(fs.readFileSync("backend/main/bracket/UL3.png")).toString("base64"),
             mimeType:"image/png",
         },
         };
...
async function  generate_l_bracket(usable_bracket,context){
    const bracketConfig = `{
        "show2d": true,
        "show3d": true,
      ...
      const image = {
      inlineData:{
          data:Buffer.from(fs.readFileSync("backend/main/bracket/L.png")).toString("base64"),
          mimeType:"image/png",
      },
      };
      ...
      const pattern_json=`"patterns": [
        ...
        const imagef = {
        inlineData:{
            data:Buffer.from(fs.readFileSync("backend/main/bracket/LF.png")).toString("base64"),
            mimeType:"image/png",
        },
        };
      ...
      9)Put only values in the json and no intermediate calculations or explanations`;
        ...
        const imageL1 = {
        inlineData:{
            data:Buffer.from(fs.readFileSync("backend/main/bracket/LL1.png")).toString("base64"),
            mimeType:"image/png",
        },
        };
      ...
      9)Put only values in the json and no intermediate calculations or explanations`;
         const imageL2 = {
         inlineData:{
             data:Buffer.from(fs.readFileSync("backend/main/bracket/LL2.png")).toString("base64"),
             mimeType:"image/png",
         },
         };
...
async function  generate_z_bracket(usable_bracket,context){
    const bracketConfig = `{
        "show2d": true,
        "show3d": true,
      ...
      const image = {
      inlineData:{
          data:Buffer.from(fs.readFileSync("backend/main/bracket/Z.png")).toString("base64"),
          mimeType:"image/png",
      },
      };
      ...
      const pattern_json=`"patterns": [
        ...
        const imagef = {
        inlineData:{
            data:Buffer.from(fs.readFileSync("backend/main/bracket/Zf.png")).toString("base64"),
            mimeType:"image/png",
        },
        };
     ...
     9)Put only values in the json and no intermediate calculations or explanations`;
        const imageL1 = {
        inlineData:{
            data:Buffer.from(fs.readFileSync("backend/main/bracket/ZL1.png")).toString("base64"),
            mimeType:"image/png",
        },
        };
      ...
      9)Put only values in the json and no intermediate calculations or explanations`;
         const imageL2 = {
         inlineData:{
             data:Buffer.from(fs.readFileSync("backend/main/bracket/ZL2.png")).toString("base64"),
             mimeType:"image/png",
         },
         };
      ...
      9)Put only values in the json and no intermediate calculations or explanations`;
         const imageL3 = {
         inlineData:{
             data:Buffer.from(fs.readFileSync("backend/main/bracket/ZL3.png")).toString("base64"),
             mimeType:"image/png",
         },
         };
...
async function  generate_offset_bracket(usable_bracket,context){
  const bracketConfig = `{
      "show2d": true,
      "show3d": true,
    ...
    const image = {
    inlineData:{
        data:Buffer.from(fs.readFileSync("backend/main/bracket/O.png")).toString("base64"),
        mimeType:"image/png",
    },
    };
    ...
    const pattern_json=`"patterns": [
      ...
      const imagef = {
      inlineData:{
          data:Buffer.from(fs.readFileSync("backend/main/bracket/OF.png")).toString("base64"),
          mimeType:"image/png",
      },
      };
     ...
     const  cuts_table= result_cuts.response.text();
      ...
      const imageL1 = {
      inlineData:{
          data:Buffer.from(fs.readFileSync("backend/main/bracket/OL1.png")).toString("base64"),
          mimeType:"image/png",
      },
      };
      ...
      9)Put only values in the json and no intermediate calculations or explanations`;
       const imageL2 = {
       inlineData:{
           data:Buffer.from(fs.readFileSync("backend/main/bracket/OL2.png")).toString("base64"),
           mimeType:"image/png",
       },
       };
      ...
      9)Put only values in the json and no intermediate calculations or explanations`;
       const imageL3 = {
       inlineData:{
           data:Buffer.from(fs.readFileSync("backend/main/bracket/OL3.png")).toString("base64"),
           mimeType:"image/png",
       },
       };
    ...
    9)Put only values in the json and no intermediate calculations or explanations`;
       const imageL4 = {
        inlineData:{
            data:Buffer.from(fs.readFileSync("backend/main/bracket/OL4.png")).toString("base64"),
            mimeType:"image/png",
        },
        };
      ...
      9)Put only values in the json and no intermediate calculations or explanations`;
         const imageL5 = {
         inlineData:{
             data:Buffer.from(fs.readFileSync("backend/main/bracket/OL5.png")).toString("base64"),
             mimeType:"image/png",
         },
         };
